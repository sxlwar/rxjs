**写在前面的话：这篇文档是对rxjs官网文档的翻译，在翻译的过程中尽量按原文档的意思进行，但肯定难免有纰漏或错误之处，欢迎指出。对于rxjs的学习还是极力推荐阅读原英文文档。[官方网站](http://reactivex.io)**
...
rxjs之所以强大的一个原因在于它使用纯函数来产生一系列的值，这将大大减少代码发生错误的可能性。
