...
将数组、类数组对象、promise、部署了遍历器接口的对象或类Observable对象转换成Observable。
...
* <font face="仿宋">_将promise转换成流，随后将promise成功resolved后发出的值推送到流上，然后发出结束通知。_</font>
...
| Name  | Type   | Attribute | Description                         |
| ----- | :----: | :-------: | ----------------------------------: |
| initialDelay | number | Date |       | 发出首个值之前的等待时间 |
